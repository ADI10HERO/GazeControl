...
class Gaze(MainModel):
    ...
    def preprocess_input(self, left_eye_crop, right_eye_crop):
        ...
        preprocessed_left_eye_crop = handle_image(left_eye_crop, self.input_shape[3], self.input_shape[2])
        preprocessed_right_eye_crop = handle_image(right_eye_crop, self.input_shape[3], self.input_shape[2])
